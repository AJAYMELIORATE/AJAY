...
int main()
{
    ...
    scanf("%d",&n);
    printf("ENTER THE NO OF BANANAS THAT ONE MONKEY CAN EAT : \n");
    scanf("%d",&k);
    printf("ENTER THE NO OF PEANUTS THAT ONE MONKEY CAN EAT : \n");
    scanf("%d",&j);
    printf("ENTER THE TOTAL NUMBER OF BANANAS : \n");
    scanf("%d",&m);
    printf("ENTER THE TOTAL NUMBER OF PEANUTST : \n");
    scanf("%d",&p);
    int x,y ;
    x= m / k;
    if (m % k != 0 && m % 2 >= 2)
    ...
    int t=x+y;
    printf("NUMBER OF MONKEYS THAT REMAIN ON THE TREES: %d",(n-t));
